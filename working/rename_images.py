...
This script renames all JPG files in the images/ folder using their EXIF timestamp
...
def main():
    ...
    if not files_to_process:
        print("No images to rename (all files already have timestamp names or no JPG files found)")
        return
